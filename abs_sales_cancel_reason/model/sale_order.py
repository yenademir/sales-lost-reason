...
class SaleOrder(models.Model):
    ...
    quota_cancel_reason_id = fields.Many2one("quotation.cancel.reason",string= "Quotation Cancellation Reason",help="This field display reason of quatation cancellation")
